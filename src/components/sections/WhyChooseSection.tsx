...
const reasons = [
  ...
  },
  {
    ...
    description:
      "Talk directly with Shoesoco for sizing, availability, and product advice.",
  },
  {
    number: "04",
    ...
    <section className="overflow-hidden py-20 sm:py-28">
      <Container>
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
          <div className="relative rounded-[2rem] bg-[#181b21] p-8 sm:p-10">
            <div className="absolute -bottom-24 -right-20 h-64 w-64 rounded-full bg-[#181b21]/60 blur-3xl" />
            <p className="eyebrow">Why Shoesoco</p>
            ...
            <p className="relative mt-14 text-7xl font-semibold tracking-[-0.08em] text-[#f4f1ea]/80 sm:text-8xl">
              01-04
            </p>
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {reasons.map((reason) => (
              <article
                className="rounded-[1.5rem] border border-neutral-200 bg-[#181b21] p-6 transition hover:-translate-y-1 hover:border-[#c6ff3a] hover:shadow-[0_18px_45px_rgba(35,31,25,0.07)]"
                key={reason.number}
              >
